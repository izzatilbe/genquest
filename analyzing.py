...
def genQuestion(line):
    ...
    if all(key in  bucket for key in l1): #'NNP', 'VBG', 'VBZ', 'IN' in sentence.
        question = 'Can you explan what' + ' ' + line.words[bucket['VBZ']] +' '+ line.words[bucket['NNP']]+ ' '+ line.words[bucket['VBG']] + '?'
        ...
        question = 'How does the '+ line.words[bucket['NN']] +' '+ line.words[bucket['VBG']] + '?'
        output.append(question)

    elif all(key in bucket for key in l8): #'NNP', 'VBZ', 'JJ' in sentence.
        question = 'Why'+ ' ' + line.words[bucket['VBZ']] + ' ' + line.words[bucket['NNP']] + ' ' +line.words[bucket['JJ']] + '?'
        output.append(question)
        ...
        question = 'How' + ' ' + line.words[bucket['VBZ']] + ' ' + line.words[bucket['NN']] + '?'
        output.append(question)
